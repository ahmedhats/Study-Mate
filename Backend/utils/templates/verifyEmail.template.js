module.exports.verificationEmailTemplate = (verificationLink, userName = 'User') => {
  return `
    ...
    <head>
      <meta charset="UTF-8">
      <title>Verify Your StudyMate Account</title>
      <style>
        body {
    ...
    <body>
      <div class="container">
        ...
        <p>Welcome to StudyMate! We're excited to have you join our community of learners.</p>
        <p>To get started with your study journey, please verify your email address by clicking the button below:</p>
        ...
        <div class="footer">
          ...
          <p>If you didn't create an account with StudyMate, please ignore this email.</p>
